...
const AdminContactus = () => {
  ...
  const getAddcontactus = async () => {
    try {
      let res = await axios.get("http://dailydishbangalore.com/api/admin/getcontactus");
      if (res.status === 200) {
  ...
  const getAddsocial = async () => {
    try {
      let res = await axios.get("http://dailydishbangalore.com/api/admin/getsocial");
      if (res.status === 200) {
                  ...
                  {Addsocial?.map((item, i) => {
                    return (
                      <tr key={i}>
                        ...
                        <td>
                          <Image
                            src={`http://dailydishbangalore.com/Contactus/${item?.CBanner}`}
                            alt="pic"
