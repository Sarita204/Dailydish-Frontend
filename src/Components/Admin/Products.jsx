...
//         "http://dailydishbangalore.com/api/admin/admin/product"
//       );
//       if (res.status === 200) {
...
//         `http://dailydishbangalore.com/api/admin/admin/deleteproduct/${delData._id}`
//       );
//       if (res) {
...
//     try {
//       let res = await axios.get("http://dailydishbangalore.com/api/admin/getcategory");
//       if (res.status === 200) {
...
//         "http://dailydishbangalore.com/api/admin/admin/updateGalleryImages",
//         formData,
//         {
//           headers: { "Content-Type": "multipart/form-data" },
//         }
...
//     try {
//       const config = {
//         url: `http://dailydishbangalore.com/api/admin/admin/DeleteGalleryimage/${Data?._id}`,
//         method: "delete",
//         baseURL: "http://dailydishbangalore.com/api/",
...
//                       <div>
//                         <img
//                           src={`http://dailydishbangalore.com/Products/${items.productimage[0]?.image}`}
//                           alt="img"
